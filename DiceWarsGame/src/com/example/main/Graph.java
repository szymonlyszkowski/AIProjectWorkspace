...
public class Graph {
	...
	public void connectChildren(Vertex vertex, int start){  // start: 0 if current vertex isn't connected to any vertex, so only in case first vertex
															//		  >0 an offset indicating where children start (depending on previously added connections)
